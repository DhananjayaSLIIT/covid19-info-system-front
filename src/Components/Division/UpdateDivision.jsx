...
const UpdateDivision = ({ handleClose, showUpdate, divisionID }) => {
    ...
    useEffect( ()=>{
        Service.getAllDistricts().then(response => {
            ...
            setDivisionNumber(divisionID.divisionNumber);
            setDivisionName(divisionID.divisionName);
            setOfficeAddress(divisionID.officeAddress);
            setOfficePhone(divisionID.officePhone);
            setDistrict(divisionID.district);
    ...
    const submitHandler = function (event) {
        ...
        if(!divisionNumber){
            ...
            Service.update_Division(newDivision,divisionID._id,config).then(response => {
        ...
        <div className={showHideClassName}>
            <section className="modal-main">
                <div className="inner-modal-main">
                    <h2 className="dis-header">Update Division</h2>
