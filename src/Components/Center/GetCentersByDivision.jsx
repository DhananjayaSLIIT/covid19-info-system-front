...
export default class GetCentersByDivision extends Component {
    ...
    componentDidMount() {
        CenterService.getCentersByDivisions(this.props.match.params.id).then(response => {
                ...
                <div className="container" id="cen-middle-container">
                    <div className="cen-conatent">
                        ...
                        <div className="cen-middle-container">
                            <label style={{fontSize:"small",fontWeight:"medium"}}>Search Center by name </label>
